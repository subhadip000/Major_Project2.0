  ...
  <main class="main-content position-relative border-radius-lg ">
      ...
      <div class="container-fluid py-1 px-3">
        <nav aria-label="breadcrumb">
          <ol class="breadcrumb bg-transparent mb-0 pb-0 pt-1 px-0 me-sm-6 me-5">
            ...
            <li class="breadcrumb-item text-sm text-white active" aria-current="page">Register Customer</li>
          </ol>
          <h6 class="font-weight-bolder text-white mb-0">Entry a Customer</h6>
        </nav>
        <!---------------->
    ...
    <div class="card m-3">
      <div class="table-responsive">
        <div class="table lign-items-center mb-2 p-2">

          <form action="entryCustomer" method="post">
            @csrf
            <div class="form-group">
              <label for="user_name">Customer Name</label>
              <input type="text" name="user_name" id="user_name" class="form-control" placeholder="Customer Name">
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
              <label for="user_phone">Customer Phone</label>
            ...
            <div class="form-group">
              ...
              <input type="text" name="user_address" id="user_address" class="form-control" placeholder="Address Line">
            </div>

            <button class="btn btn-primary form-control" type="submit">Entry Customer</button>
    ...
    <!--Footer-->
    <footer class="footer pt-3  fixed-button">
