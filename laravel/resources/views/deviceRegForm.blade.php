      ...
      <div class="container-fluid py-1 px-3">
        <nav aria-label="breadcrumb">
          <ol class="breadcrumb bg-transparent mb-0 pb-0 pt-1 px-0 me-sm-6 me-5">
            ...
            <li class="breadcrumb-item text-sm text-white active" aria-current="page">Register Device</li>
          </ol>
          <h6 class="font-weight-bolder text-white mb-0">Register a Device</h6>
        </nav>
        <!---------------->
    ...
    <div class="card m-3">
      <div class="table-responsive">
        <div class="table lign-items-center mb-2 p-2">
          ...
          <form action="deviceRegForm" method="post">
            @csrf
            <?php
            if ($message == "") {
            } else {
            ...
            <div class="form-group">
              ...
              <input type="text" name="device_code" id="device_code" class="form-control" placeholder="Device Code">
            </div>
            <div class="form-group">
            ...
            <button class="btn btn-primary form-control" type="submit">Register Device</button>
