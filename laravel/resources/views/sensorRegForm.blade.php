      ...
      <div class="container-fluid py-1 px-3">
        <nav aria-label="breadcrumb">
          <ol class="breadcrumb bg-transparent mb-0 pb-0 pt-1 px-0 me-sm-6 me-5">
            ...
            <li class="breadcrumb-item text-sm text-white active" aria-current="page">Sensor Register</li>
          </ol>
          <h6 class="font-weight-bolder text-white mb-0">Register a Sensor</h6>
        </nav>
        <!---------------->
    ...
    <div class="card m-3">
      <div class="table-responsive">
        <div class="table lign-items-center mb-2 p-2">
          ...
          <form action="sensorRegForm" method="post">
            @csrf
            <div class="form-group">
              <label for="sensor_type">Sensor Type</label>
              <input type="text" name="sensor_type" id="sensor_type" class="form-control" placeholder="Sensor Type">
            </div>
            <div class="form-group">
              <label for="sensor_name">Sensor Name</label>
              <input type="text" name="sensor_name" id="sensor_name" class="form-control" placeholder="Sensor Name">
            </div>
            <button class="btn btn-primary form-control" type="submit">Sensor Register</button>
