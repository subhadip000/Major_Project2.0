      ...
      <div class="container-fluid py-1 px-3">
        <nav aria-label="breadcrumb">
          <ol class="breadcrumb bg-transparent mb-0 pb-0 pt-1 px-0 me-sm-6 me-5">
            ...
            <li class="breadcrumb-item text-sm text-white active" aria-current="page">Issue Device</li>
          </ol>
          <h6 class="font-weight-bolder text-white mb-0">Issue a Device</h6>
        </nav>
        <!---------------->
    ...
    <div class="card m-3">
      <div class="table-responsive">
        <div class="table lign-items-center mb-2 p-2">
          ...
          <form action="deviceIssueForm" method="post">
            @csrf
            <div class="form-group">
              <label for="device_id">Device Id</label>
              <input type="text" name="device_id" id="device_id" class="form-control" placeholder="Device Id">
            </div>
            <div class="form-group">
              <label for="customer_id">Customer Id</label>
              <input type="text" name="customer_id" id="customer_id" class="form-control" placeholder="Customer Id">
            </div>
            <button class="btn btn-primary form-control" type="submit">Issue Device</button>
